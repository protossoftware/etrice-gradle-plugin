...
TIP: For more detailed information about all provided classes also see the generated https://protossoftware.github.io/etrice-gradle-plugin/javadoc[javadoc].
